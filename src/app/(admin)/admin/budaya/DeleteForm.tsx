...
export default function DeleteForm({ id }: { id: string }) {
  ...
  const handleDelete = () => {
    if (confirm("Apakah Anda yakin ingin menghapus konten budaya ini secara permanen?")) {
      startTransition(async () => {
        try {
          ...
          console.error("Gagal menghapus konten budaya:", error);
          alert("Gagal menghapus konten budaya. Silakan coba lagi.");
        }
      });
    }
  };
