...
import { LayoutDashboard, Map, Sparkles, Store, Newspaper, Users, Sliders, Image as ImageIcon, Megaphone, FileText, TrendingUp, Menu, X, Bot, Droplets, Scale, Link2, Handshake } from "lucide-react";
        ...
        <nav className="flex-1 p-4 space-y-1.5 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-800">
          {status === "loading" ? (
            ...
            [
              ...
              { name: "Kelola Kolaborator", href: "/admin/kolaborator", icon: Handshake, perms: ["MANAGE_COLLABORATORS"] },
