...
export default function DeleteForm({ id }: { id: string }) {
  ...
  const handleDelete = () => {
    if (confirm("Apakah Anda yakin ingin menghapus destinasi ini secara permanen?")) {
      startTransition(async () => {
        try {
          ...
          console.error("Gagal menghapus destinasi wisata:", error);
          alert("Gagal menghapus destinasi wisata. Silakan coba lagi.");
        }
      });
    }
  };
